...
class MainViewController(QObject):
    ...
    def __init__(self, window):
        ...
        self.Window.ClearServerButton.clicked.connect(self.clear_server_data)
        self.Window.ClearClientButton.clicked.connect(self.clear_client_data)
        self.Window.ClearUdpButton.clicked.connect(self.clear_udp_data)
    ...
    def connect_to_server(self):
        self.Window.loadingIcon.setFixedSize(QtCore.QSize(250, 250))
        self.Window.loadingIcon.setGeometry(QtCore.QRect(200, 110, 81, 23))
    ...
    def invoke_connect_to_server(self, is_successful):
        self.Window.loadingIcon.setFixedSize(QtCore.QSize(0, 0))
